...
def default_execution_providers() -> List[str]:
    """Apple Silicon: prefer CoreML (GPU + Neural Engine). Others: CPU unless CUDA is typical."""
...
def parse_args() -> None:
    ...
    program.add_argument('--execution-provider', help='execution provider', dest='execution_provider', default=default_execution_providers(), choices=suggest_execution_providers(), nargs='+')
